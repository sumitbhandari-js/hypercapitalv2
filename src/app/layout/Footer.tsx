...
export const Footer = () => {
  const navigation = {
    solutions: [
      { name: "Oil & Gas Projects", href: "#" },
      { name: "Renewable Power Projects", href: "#" },
      { name: "Agriculture Projects", href: "#" },
      { name: "Healthcare", href: "#" },
      { name: "Trade and Finance", href: "#" },
      { name: "Commodities", href: "#" },
      { name: "Corporate Training and Development", href: "#" },
      { name: "Capital Solicitation and Finance", href: "#" },
    ],
