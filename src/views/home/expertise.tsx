        ...
        <div className="max-w-7xl mx-auto xl:py-24 lg:py-24 py-14 xl:space-y-8 lg:space-y-8 xl:px-6 lg:px-6 px-5">
          <ScrollAnimtion>
            ...
            <p className="lg:text-xl xl:text-xl text-base font-light text-justify xl:leading-8 lg:leading-8 leading-7">
              ...
              our success to a strong team of subject matter experts in each of our business interests and
              their ability to develop intelligent tactical strategies that are customized to each client and
              their individual business and socio-economic-political environment.
            </p>
          </ScrollAnimtion>
        </div>
      </div>
